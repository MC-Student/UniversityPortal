...
{
    public partial class LoggedInAdminPortal : Form
    {
        private string username;
        private SqlConnection sqlCon;
        public LoggedInAdminPortal(string user)
        {
            InitializeComponent();
            this.username = user;
            CreateConnection();
            PopulateAdminInformation(username);
        }
        ...
        private void PopulateAdminInformation(string username) 
        {
